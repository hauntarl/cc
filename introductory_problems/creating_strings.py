...
@timeit
def creating_strings_inplace(inp: list[str], beg: int, func) -> None:
    """
    [Easy] https://cses.fi/problemset/task/1622
    [Solution] https://cses.fi/problemset/result/4776092/
    ...
    creating_strings_inplace(inp, beg + 1, func)
...
if __name__ == '__main__':
    perms = set()
    creating_strings_inplace(list('aabac'), 0, perms.add)
